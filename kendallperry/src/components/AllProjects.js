...
const projectBank = [
    ...
    }, 
    {
        ...
        description: 'Data Vizualization challenge displaying real data from IHME using the Victory library',
        image: ihmeDataViz,
    },
    {
        title: "Portfolio",
        deployedUrl: '',
        github: 'https://github.com/kendallperry/kendall-portfolio/tree/main/kendallperry',
